...
Around the same time, I had learned of the PSP hacking community when I joined a podcast's forums and later made [what I consider my first "contribution" to the Internet on their "How-To" boards](https://web.archive.org/web/20070527021714/http://www.toosmartguys.com:80/forum/viewforum.php?f=13&sid=976942f4f481ab2ef2a363ef6bccf058). I made some music and graphics for [this episode, too](https://www.youtube.com/watch?v=KK3GvV6IM6k).
...
The PSP group was *very* technical when the Internet primarily consisted of technical people. I became unconcerned with the state of any beasts in the machine. "[Bricking](http://www.catb.org/jargon/html/B/brick.html)" your handheld was standard nomenclature when reading the [README](https://blog.bitsrc.io/how-to-write-beautiful-and-meaningful-readme-md-for-your-next-project-897045e3f991) file that was [RARed](https://www.rarlab.com/) with what you were trying to do (it was an [EBOOT.PBP](https://www.psdevwiki.com/ps3/Eboot.PBP)). In short: you relinquish your rights to the possibility that you could render your device as useful as a brick. We were the rebels of the gaming world, unsatisfied with its current offerings. Like C, C++, Python, and PHP before it, my interest in Lua waned. I found it to be very limited in its basic form. To me, being tied to a device was reckless.

For some years prior, I focused on graphic design groups like  
Skandalouz Designz ([Forum archive](https://web.archive.org/web/20051215020329/http://aeomv3.proboards43.com:80/), [Website archive](https://web.archive.org/web/20070104003717/http://www.skandalouzdesignz.net/home.html)) and mAsDesigns (mD) to learn how Adobe PhotoShop works. After these similar experiences, I noticed a recurring theme of sharing technical problems with web-based communities. Finding decent or near-complete screenshots of forums from this period is especially painful. Most free image hosts have effectively broken decades-since-abandoned accounts ([Photobucket!!](https://medium.com/@AxelUnlimited/how-photobucket-broke-the-internet-and-why-you-should-care-4a244bda6b7e)) and respective images. One of mD's two graphic designers, Sunjo, is sometimes active on deviantArt, and you can see what these templates looked like below:

![mDv5](/assets/img/blog/posts/dreaming-in-code-lucid-dreaming/mDv5.jpg)

[Found on deviantArt](https://www.deviantart.com/sunjo/art/Rusted-Cracked-Broken-53604596)

![4our_sunjo](/assets/img/blog/posts/dreaming-in-code-lucid-dreaming/4our_sunjo.jpg)

[Found on deviantArt](https://www.deviantart.com/sunjo/art/Almost-Organic-118002956)
...
#### [Why Do We Build Castles in the Sky?](https://urbigenous.net/library/how_to_build.html)

The Chandler project's language of choice was Python, something as flexible as my favored JavaScript was unthinkable. A lack of persistent databases like MySQL rendered it reasonably limited in programming. JavaScript's possibilities have since been sent into the [stratosphere](https://insights.stackoverflow.com/survey/2019#technology) with [Node.js](https://nodejs.org/).

[Next.js](https://nextjs.org/), [Gatsby](https://www.gatsbyjs.org/), [11ty](https://github.com/11ty/eleventy), [Vue.js](https://vuejs.org/), there is a mouthful of popular Node.js-based frameworks that wax and wane faster than I learn about them. That isn't to say this is a problem. This is "The Bazaar" of goods we've been building with miniature castles in the [near](https://aws.amazon.com/) [literal](https://cloud.google.com/) [sky](https://digitalocean.com/):
...
##### [Chandler Design Goals](https://www.chandlerproject.org/vision-2/)
...
By revisiting a time when the web started to accelerate, I found many of these laws have proven themselves. This is only exacerbated by an acquisition of the [RedHat Linux distribution by IBM to the tune of $34B](https://www.redhat.com/en/about/press-releases/ibm-closes-landmark-acquisition-red-hat-34-billion-defines-open-hybrid-cloud-future) and a more open-ended approach by Microsoft (who also put their money where their mouth is by acquiring [GitHub](https://blogs.microsoft.com/blog/2018/10/26/microsoft-completes-github-acquisition/)). In 2016, Microsoft joined the board of the [Linux Foundation as a platinum member](https://www.linuxfoundation.org/press-release/2016/11/microsoft-fortifies-commitment-to-open-source-becomes-linux-foundation-platinum-member/) and then, in early 2020, added to their collection with [npm](https://www.zdnet.com/article/microsoft-buys-javascript-developer-platform-npm-plans-to-integrate-it-with-github/).

Rosenberg stuck in my prototypical software developer's mind. As a teenager, this lit countless metaphorical beacons in the technical realm. It sparked an interest in [Version Control](https://git-scm.com/book/en/v2/Getting-Started-About-Version-Control), [Test-Driven Design](https://www.obeythetestinggoat.com/) and led to my installing more than the [Ubuntu](https://ubuntu.com/) distro because of these tendrils.
...
Closed-source software was uncommon until the mid-1970s to the 1980s, when [IBM implemented in 1983 an "object code only" policy](https://www.landley.net/history/mirror/ibm/oco.html), no longer distributing source code. IBM's stated reason for this was users would make modifications to their source, and IBM was expected to support these changes, which was unfeasible. Nothing in open source was formalized until at MIT, Richard Stallman began the GNU (GNU is Not [Unix](https://www.opengroup.org/membership/forums/platform/unix)) project in 1984, which created critical tools that formed a portion of an Open Source operating system. It was, however, missing a most vital piece: the kernel.
...
In 1991, Linus Torvalds, who at the time was a second-year graduate student at the University of Helsinki, wrote and distributed a Unix-like kernel ([what's Unix?](https://kb.iu.edu/d/agat)). In the first noted manner of something like FOSS development, it was distributed widely, improved upon, and soon adapted to become the core of the GNU/Linux operating system. This glosses over how vital each of these projects has been in their respective ways, but I encourage anyone to share their thoughts in the comments since it's a bit opinionated ;).
...
[In full](http://www.unterstein.net/su/docs/CathBaz.pdf).
...
Packaging and distributing your operating system running the Linux kernel is commonplace. There are virtually limitless ["distros"](https://english.stackexchange.com/a/155613) available, with more being created daily. They vary in ease of use and technical capability and are all reasonably customizable (some more than others). Based on the popular Ubuntu, I recommend starting with [Linux Mint](https://linuxmint.com/),  but I reiterate: [this is](https://itsfoss.com/linux-mint-vs-ubuntu/) [open to debate](https://www.slant.co/versus/2689/18538/~ubuntu_vs_linux-mint).

For an up-to-date list of the most popular distros, [see distrowatch here](https://distrowatch.com/dwres.php?resource=major). Install any distro at your own risk. The live mode is an excellent way to try out an OS. It is also much slower than running through your local disk.

A similar concept is repositories ("repos"). You might have seen repositories in places like [GitHub](https://help.github.com/en/github/creating-cloning-and-archiving-repositories/about-repositories), but consider [Apple's App Store](https://www.apple.com/ios/app-store/). Excluded initially from [iPhone OS (today, iOS)](https://en.wikipedia.org/wiki/IPhone_OS_1), the only way to retrieve external applications on the original iPhone was by ["jailbreaking"](https://en.wikipedia.org/wiki/IOS_jailbreaking) your device to install the [Cydia app](http://www.saurik.com/id/1). Cydia offered what would be seen on any other [Unix device](https://www2.dmst.aueb.gr/dds/pubs/conf/2015-MSR-Unix-History/html/Spi15c.html): [repository sources](https://cydia-app.com/repo-sources/). It was only after what Cydia did in February 2008 that Apple launched [its walled-garden iteration less than six months later in July](https://appleinsider.com/articles/08/07/10/apples_app_store_launches_with_more_than_500_apps). The same concept has since come into fruition on [macOS](https://apps.apple.com/us/app/macos-catalina/id1466841314?mt=12) and [Windows](https://www.microsoft.com/en-us/store/apps/windows).
...
An excellent resource for learning more about the Linux Command Line Interface is ["The Linux Command Line"](https://books.google.com/books?id=OCFKdl3wEDIC) by William E. Shotts, Jr.
...
Another cog in a continuous pattern of finding a means to an end, the very end didn't have a destination beyond knowledge from a subconscious standpoint attempting to sponge what all of [*this*](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/this) meant. In an exploded view, my impatience (eagerness) is laughable (incredible). If I had known then what I know now, I might've told myself to turn around, but my stubborn (persistent) self would ignore it anyway.

I've felt my engineering itch Raymond refers to. The web *feels stale*. When I traverse the Internet today, I'm not in the same awe I was in 2007. I'm not sure when [this shifted](https://en.wikipedia.org/wiki/Apache_Wave), but it's as though we've pressed against our castle design's ceiling. Castle towers can only be built so high.

We've become inundated with gestures over substance when we need continuity of an abundant source, but one so declarative that it can be uniformly agreed upon. This isn't an easy task, but [one challenged by the all-exalted Google](https://fuchsia.dev/fuchsia-src/concepts). Any fortune teller could lead us down where that path leads. I think a lot of the answers we seek aren't down ones typically followed.

These should be the [same philosophical questions](https://www.ted.com/talks/janelle_shane_the_danger_of_ai_is_weirder_than_you_think?language=en) [we asked ourselves](https://www.youtube.com/watch?v=wzicXbnmllc) as we [turned the millennium](https://www.nytimes.com/2001/06/28/technology/lessons-in-internet-plagiarism.html) and engaged with approach rather than the result, or we'll be lost to these questions forever. As ubiquity reigns, [all leaders be supreme](https://www.visualcapitalist.com/the-big-five-largest-acquisitions-by-tech-company/), but less so of the people.
